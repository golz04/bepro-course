...
class MentorCourseModuleController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return view('mentor.pages.course-module.list', $this->param);
        } catch (\Exception $e) {
    ...
    public function add()
    {
        try {
            ...
            return view('mentor.pages.course-module.add', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect('/back-mentor/course-module/add-course-module')->withStatus('Berhasil menambah data.');
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function edit($id)
    {
        try {
            ...
            return view('mentor.pages.course-module.edit', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect('/back-mentor/course-module/list-course-module')->withStatus('Berhasil memperbarui data.');
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect('/back-mentor/course-module/list-course-module')->withStatus('Berhasil menghapus data.');
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
