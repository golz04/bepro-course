...
class MentorBenefitCourseController extends Controller
{
    ...
    public function index(){
        try {
            ...
            return view('mentor.pages.course-benefit.list', $this->param);
        } catch (\Exception $e) {
    ...
    public function store(Request $request){
        ...
        try {
            ...
            return redirect('/back-mentor/benefit-course/list-benefit-course')->withStatus('Berhasil menambahkan data.');
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect('/back-mentor/benefit-course/list-benefit-course')->withStatus('Berhasil menghapus data.');
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
