...
class MentorCourseModuleQuizController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return view('mentor.pages.course-module-quiz.list', $this->param);
        } catch (\Exception $e) {
    ...
    public function add()
    {
        try {
            ...
            return view('mentor.pages.course-module-quiz.add', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect('/back-mentor/course-module-quiz/add-course-module-quiz')->withStatus('Berhasil menambah data.');
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect('/back-mentor/course-module-quiz/list-course-module-quiz')->withStatus('Berhasil memperbarui data.');
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function edit($id)
    {
        try {
            ...
            return view('mentor.pages.course-module-quiz.edit', $this->param);
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect('/back-mentor/course-module-quiz/list-course-module-quiz')->withStatus('Berhasil menghapus data.');
        } catch (\Exception $e) {
            return redirect()->back()->withError($e->getMessage());
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect()->back()->withError('Terjadi kesalahan pada database', $e->getMessage());
