                    ...
                    <div class="card-body border-top p-9">
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="course_name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('course_name') is-invalid @enderror" placeholder="Nama Course" value="{{old('course_name', $getCourseDetail->course_name)}}" />
                                @error('course_name')
