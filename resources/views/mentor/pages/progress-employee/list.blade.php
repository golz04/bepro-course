...
<div class="toolbar" id="kt_toolbar">
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex text-dark fw-bolder fs-5 align-items-center my-1"><span class="text-muted fw-normal">Beranda - Menu Mentor - Progress Karyawan - </span>&nbsp;List Data Progress Karyawan</h1>
        </div>
        {{-- <div class="d-flex align-items-center gap-2 gap-lg-3">
            <a href="{{url('/back-mentor/division-position/add-position')}}" class="btn btn-sm btn-primary">Tambah Data</a>
        </div> --}}
    </div>
</div>
@endsection
            ...
            <div class="col-md-6 col-xxl-4">
                <div class="card border">
                    <div class="card-body d-flex flex-center flex-column p-9">
                        ...
                        <form action="{{url('/back-mentor/progress-employee/detail-progress-employee/'.$item->id)}}" method="POST">
                            @csrf
