...
<div class="toolbar" id="kt_toolbar">
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex text-dark fw-bolder fs-5 align-items-center my-1"><span class="text-muted fw-normal">Beranda - Menu Mentor - Progress Karyawan - </span>&nbsp;Detail Data Progress Karyawan</h1>
        </div>
    </div>
</div>
@endsection
                    ...
                    <div class="flex-grow-1">
                        <div class="d-flex justify-content-between align-items-start flex-wrap">
                            ...
                            <div class="d-flex my-4">
                                <a href="{{url('/back-mentor/progress-employee/report-quiz/'.$getUserID.'/'.$item->slug).'/persiapan-course'}}" class="btn btn-sm btn-primary me-2">Berikan Penilaian Quiz</a>
                            </div>
                            {{-- <div class="d-flex my-4">
