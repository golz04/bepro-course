            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div data-kt-menu-trigger="click" class="menu-item @if (Request::Segment(2) == 'division-position') here show @endif menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion @if (Request::Segment(2) == 'division-position') menu-active-bg @endif">
                        <div class="menu-item">
                            <a class="menu-link @if (Request::Segment(3) == 'list-division') active @endif" href="{{url('/back-mentor/division-position/list-division')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link @if (Request::Segment(3) == 'add-division') active @endif" href="{{url('/back-mentor/division-position/add-division')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link @if (Request::Segment(3) == 'list-position') active @endif" href="{{url('/back-mentor/division-position/list-position')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link @if (Request::Segment(3) == 'add-position') active @endif" href="{{url('/back-mentor/division-position/add-position')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item @if (Request::Segment(2) == 'user') here show @endif menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion @if (Request::Segment(2) == 'user') menu-active-bg @endif">
                        <div class="menu-item">
                            <a class="menu-link @if (Request::Segment(3) == 'list-employee') active @endif" href="{{url('/back-mentor/user/list-employee')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link @if (Request::Segment(3) == 'add-employee') active @endif" href="{{url('/back-mentor/user/add-employee')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link @if (Request::Segment(3) == 'list-mentor') active @endif" href="{{url('/back-mentor/user/list-mentor')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link @if (Request::Segment(3) == 'add-mentor') active @endif" href="{{url('/back-mentor/user/add-mentor')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
